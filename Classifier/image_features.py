...
def Decode_Extract_Features(base64_img):
    ...
    model_file = "/Banana-Project-API/Classifier/Models/ResNet-50-model.caffemodel"
    deploy_prototxt = "/Banana-Project-API/Classifier/Models/ResNet-50-deploy.prototxt"
